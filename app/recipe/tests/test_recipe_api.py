...
def create_recipe(user, **params):
    "Creates and return a new recipe."
    defaults = {
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            'title': 'Update recipe',
            'description': 'Updateest description',
    ...
    def test_create_recipe_with_new_tags(self):
        """Create new recipe with new tags."""
    ...
    def test_create_tag_on_update(self):
        ...
        payload = {'tags': [{'name': 'Lunch'}, {'name': 'Filipino'}]}
        url = detail_url(recipe.id)
    ...
    def test_clear_recipe_tags(self):
        ...
        tag_filipino = Tag.objects.create(user=self.user, name='Filipino')
        recipe = create_recipe(user=self.user)
        recipe.tags.add(tag_filipino)
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertNotIn(tag_filipino, recipe.tags.all())
        self.assertEqual(recipe.tags.count(), 0)

    def test_recipe_with_new_ingredients(self):
        """Test adding ingredients on creating a recipe."""
        payload = {
            'title': 'Adobong Manok',
            'time_minutes': 30,
            'price': Decimal('3.50'),
            'ingredients': [{'name': 'Tomato'}, {'name': 'Mango'}]
        }
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('3.50'),
            'ingredients': [{'name': 'Lemon'}, {'name': 'Mango'}]
        }
    ...
    def test_create_ingredient_on_update(self):
        """Test creating ingredient when a recipe updated."""
        recipe = create_recipe(user=self.user)
        payload = {
            'ingredients': [{'name': 'Tomato'}, {'name': 'Mango'}]
        }
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test updating assigned ingredients on a recipe."""
        ingredient_tomato = Ingredient.objects.create(user=self.user,
                                                      name='Tomato')
        recipe = create_recipe(user=self.user)
        ...
        self.assertNotIn(ingredient_tomato,
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Fried Chicken')
